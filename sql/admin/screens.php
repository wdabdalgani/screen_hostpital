...
?>
    ...
    <section class="saas-card section">
      ...
      <form method="post" class="form form--row">
        ...
        <div class="form__group">
          ...
          <input class="form__input form__input--sm" type="number" name="slide_seconds" min="5" max="10" value="8">
        </div>
        <div class="form__group">
    ...
    <section class="section">
      ...
      <?php foreach ($screens as $s): ?>
        <?php
        $link = url('display.php?token=' . $s['token']);
        $offlinePrepLink = url('display.php?token=' . $s['token'] . '&offline_sync=1');
        ?>
        <div class="screen-card">
          <form method="post" class="screen-card__form">
            ...
            <div class="screen-card__row">
              ...
              <input class="form__input form__input--sm" type="number" name="slide_seconds" min="5" max="10" value="<?= (int) $s['slide_seconds'] ?>">
          ...
          <div class="screen-card__link">
            <a class="btn btn--ghost" href="<?= esc($link) ?>" target="_blank" rel="noopener">فتح الشاشة</a>
            <a
              class="btn btn--ghost"
            ...
            >تجهيز أوفلاين</a>
            <input type="text" readonly class="form__input form__input--mono" value="<?= esc($link) ?>" onclick="this.select()">
          </div>
